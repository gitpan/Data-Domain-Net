package Data::Domain::Net::IPAddress::IPv6_TEST;
...
sub run {
    ...
    isa_ok($domain, 'Data::Domain::Net::IPAddress::IPv6');
    isa_ok($domain, 'Data::Domain::SemanticAdapter');
    isa_ok($domain->adaptee, 'Data::Semantic::Net::IPAddress::IPv6');
}
...
Data::Domain::Net::IPAddress::IPv6_TEST - Test companion class
...
Test companion class for L<Data::Domain::Net::IPAddress::IPv6>. Gets its
test data from L<Data::Semantic::Net::IPAddress::TestData::IPv6>.

Data::Domain::Net::IPAddress::IPv6_TEST inherits from
L<Data::Domain::SemanticAdapter::Test> and
L<Data::Semantic::Net::IPAddress::TestData::IPv6>.
